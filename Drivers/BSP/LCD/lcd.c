...
uint8_t font_index = ch - 32U;
    ...
    {
        case 12:
            pfont = (uint8_t *)asc2_1206[font_index];  /* ����1206���� */
            break;

        case 16:
            pfont = (uint8_t *)asc2_1608[font_index];  /* ����1608���� */
            break;

        case 24:
            pfont = (uint8_t *)asc2_2412[font_index];  /* ����2412���� */
            break;

        case 32:
            pfont = (uint8_t *)asc2_3216[font_index];  /* ����3216���� */
            break;
