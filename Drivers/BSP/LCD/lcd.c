...
uint8_t font_index = ch - 32U;
    switch (size)
    {
        case 12:
            pfont = (uint8_t *)asc2_1206[font_index];  /* 调用1206字体 */
            break;

        case 16:
            pfont = (uint8_t *)asc2_1608[font_index];  /* 调用1608字体 */
            break;

        case 24:
            pfont = (uint8_t *)asc2_2412[font_index];  /* 调用2412字体 */
            break;

        case 32:
            pfont = (uint8_t *)asc2_3216[font_index];  /* 调用3216字体 */
            break;
