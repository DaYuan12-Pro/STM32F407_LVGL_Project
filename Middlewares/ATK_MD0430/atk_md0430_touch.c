...
/* ATK-MD0430ģ�鴥�����ּĴ������� */
#define ATK_MD0430_TOUCH_REG_CTRL           0x8040  /* ���ƼĴ��� */
#define ATK_MD0430_TOUCH_REG_PID            0x8140  /* PID�Ĵ��� */
#define ATK_MD0430_TOUCH_REG_TPINFO         0x814E  /* ����״̬�Ĵ��� */
#define ATK_MD0430_TOUCH_REG_TP1            0x8150  /* ������1���ݼĴ��� */
#define ATK_MD0430_TOUCH_REG_TP2            0x8158  /* ������2���ݼĴ��� */
#define ATK_MD0430_TOUCH_REG_TP3            0x8160  /* ������3���ݼĴ��� */
#define ATK_MD0430_TOUCH_REG_TP4            0x8168  /* ������4���ݼĴ��� */
#define ATK_MD0430_TOUCH_REG_TP5            0x8170  /* ������5���ݼĴ��� */
...
/**
 * @brief       ATK-MD0430ģ�鴥����ʼ��
 * @param       ��
 * @retval      ATK_MD0430_TOUCH_EOK  : ATK-MD0430ģ�鴥����ʼ���ɹ�
 *              ATK_MD0430_TOUCH_ERROR: ATK-MD0430ģ�鴥����ʼ��ʧ��
 */
...
/**
 * @brief       ATK-MD0430ģ�鴥��ɨ��
 * @note        �������ü�������10ms
 * @param       point: ɨ�赽�Ĵ�������Ϣ
 *              cnt  : ��Ҫɨ��Ĵ�����������1~ATK_MD0430_TOUCH_TP_MAX��
 * @retval      0   : û��ɨ�赽������
 *              ����: ʵ�ʻ�ȡ���Ĵ�������Ϣ����
 */
