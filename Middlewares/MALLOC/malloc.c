...
/* GCC memory pools; requires matching sections in the linker script. */
...
static uint8_t mem2base[MEM2_MAX_SIZE]
    __attribute__((section(".pool_ccm"), aligned(64)));
static MT_TYPE mem2mapbase[MEM2_ALLOC_TABLE_SIZE]
    __attribute__((section(".map_ccm"), aligned(4)));

static uint8_t mem3base[MEM3_MAX_SIZE]
    __attribute__((section(".pool_ext"), aligned(64)));
static MT_TYPE mem3mapbase[MEM3_ALLOC_TABLE_SIZE]
    __attribute__((section(".map_ext"), aligned(4)));
...
struct _m_mallco_dev mallco_dev =
{
    ...
    .membase = {mem1base, mem2base, mem3base},
    .memmap = {mem1mapbase, mem2mapbase, mem3mapbase},
    .memrdy = {0, 0, 0}
};
